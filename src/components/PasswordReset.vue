<template>
  <div
    class="mx-auto max-w-md rounded-2xl border border-brand-neon/20 bg-brand-card p-6 text-brand-night"
  >
    <h2 class="text-xl font-semibold text-brand-ink mb-2">Resetear contraseña</h2>
    <p class="text-sm text-brand-ink/70 mb-4">
    ...
    <form @submit.prevent="submit">
      ...
      <div class="relative mb-3">
        ...
        <button
          ...
          class="absolute right-2 top-1/2 -translate-y-1/2 text-sm opacity-80"
        ...
        >
          ...
          >
            <path
              ...
              stroke-linejoin="round"
              stroke-width="2"
              d="M13.875 18.825A10.05 10.05 0 0112 19c-4.477 0-8.268-2.943-9.542-7a9.956 9.956 0 012.223-3.582M6.1 6.1A9.966 9.966 0 0112 5c4.477 0 8.268 2.943 9.542 7a9.97 9.97 0 01-4.35 5.37M3 3l18 18"
            />
          </svg>
        </button>
      </div>
      ...
      <button
        class="w-full rounded-full bg-brand-neon py-2 text-sm font-semibold text-brand-night disabled:opacity-60"
